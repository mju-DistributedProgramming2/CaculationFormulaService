...
public class HomeFormulaForService extends CalculationFormulaForService {
	...
	public HomeFormulaForService(String calculationFormulaName, HashMap<PillarType, RiskLevel> riskLevelAccordingToPillarType,
	...
	public HomeFormulaForService(String calculationFormulaName, HashMap<PillarType, RiskLevel> riskAccordingToPillarType, HashMap<RoofType, RiskLevel> riskAccordingToRoofType, HashMap<OutwallType, RiskLevel> riskAccordingToOutwallType, int multiplierForMinCompensation, int multiplierForMaxCompensation, int multiplierForPayment) {
		super(calculationFormulaName, riskAccordingToPillarType, riskAccordingToRoofType, riskAccordingToOutwallType, multiplierForMinCompensation, multiplierForMaxCompensation, multiplierForPayment);
	}
